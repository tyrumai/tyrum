...
- `infra/` – Docker Compose, Kubernetes manifests, and the Helm chart.
...
6. **Follow CI workflows:** Run the same commands locally that GitHub Actions enforces (`cargo fmt/clippy/test`, `npm run lint/test/build`, Compose/Kubernetes/Helm validations).
