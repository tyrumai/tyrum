...
See [Data lifecycle and retention](/architecture/data-lifecycle) for how artifact retention fits into broader StateStore/outbox/transcript lifecycle decisions.
...
3. `by_label.<label>`
4. `default_days` / `default_max_bytes`
