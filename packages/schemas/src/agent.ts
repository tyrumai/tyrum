...
export const CompactionConfig = z.object({
  ...
  tool_result_max_chars: z.number().int().min(128).default(2048),
});
...
export const AgentSessionConfig = z.object({
  ...
  compaction: CompactionConfig.default({ enabled: true, preserve_recent: 6, trigger_message_count: 20, tool_result_max_chars: 2048 }),
});
...
export const AgentConfig = z.object({
  ...
  sessions: AgentSessionConfig.default({ ttl_days: 30, max_turns: 20, typing: { mode: "message", refresh_interval_ms: 3000 }, compaction: { enabled: true, preserve_recent: 6, trigger_message_count: 20, tool_result_max_chars: 2048 } }),
