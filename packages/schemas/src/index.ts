...
// prettier-ignore
export { DEFAULT_DESKTOP_ENVIRONMENT_IMAGE_REF, DesktopEnvironmentId, DesktopEnvironmentHostId, DesktopEnvironmentStatus, DesktopEnvironmentManagedKind, DesktopEnvironmentHost, isDesktopEnvironmentHostAvailable, describeDesktopEnvironmentHostAvailability, DesktopEnvironment, DesktopEnvironmentHostListResponse, DesktopEnvironmentListResponse, DesktopEnvironmentGetResponse, DesktopEnvironmentCreateRequest, DesktopEnvironmentUpdateRequest, DesktopEnvironmentMutateResponse, DesktopEnvironmentDeleteResponse, DesktopEnvironmentLogsResponse, DesktopEnvironmentTakeoverResponse, DesktopEnvironmentDefaultsResponse, DesktopEnvironmentDefaultsUpdateRequest } from "./desktop-environment.js";
// prettier-ignore
