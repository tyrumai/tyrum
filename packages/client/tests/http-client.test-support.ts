...
const adminApiPaths = [
  ...
  "agentList.get",
  "agentStatus.get",
  "channelConfig.listRegistry",
  "channelConfig.listChannels",
  "channelConfig.createAccount",
  "channelConfig.updateAccount",
  "channelConfig.deleteAccount",
  "routingConfig.get",
  "routingConfig.listRevisions",
  "routingConfig.listObservedTelegramThreads",
  "routingConfig.listChannelConfigs",
  "routingConfig.createChannelConfig",
  "routingConfig.update",
  "routingConfig.updateChannelConfig",
  "routingConfig.deleteChannelConfig",
