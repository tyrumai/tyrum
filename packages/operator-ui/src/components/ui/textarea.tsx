    ...
    return (
      <div className="grid gap-2">
        ...
        <textarea
          ...
          className={cn(
            "flex min-h-20 w-full rounded-md border border-border/80 bg-bg-card/40 backdrop-blur-md px-3 py-2 text-sm text-fg shadow-inner transition-all duration-200",
