...
export function CreateChannelDialog({
  ...
  const [accountKeyAutoGenerated, setAccountKeyAutoGenerated] = React.useState(true);
  ...
  React.useEffect(() => {
    if (!open) {
      ...
      setAccountKey("");
      setAccountKeyAutoGenerated(true);
    ...
    if (accountKeyAutoGenerated) {
      setAccountKey(generatedAccountKey);
    }
  }, [accountKeyAutoGenerated, generatedAccountKey, open]);
        ...
        <div className="grid gap-4">
          ...
          <Input
            ...
            onChange={(event) => {
              ...
              setAccountKeyAutoGenerated(false);
            }}
          />
