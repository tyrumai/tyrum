export const MIGRATION_FILENAME_ALIASES: Readonly<Record<string, readonly string[]>> = {
  ...
  "134_desktop_environments.sql": ["131_desktop_environments.sql", "132_desktop_environments.sql"],
  ...
  "137_conversation_messages_json.sql": ["133_conversation_messages_json.sql"],
