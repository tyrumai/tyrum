...
import { ChatConversationReconnectRequest, requireTenantClient } from "./ai-sdk-chat-shared.js";
...
export async function handleChatConversationReconnectMessage(
  ...
  const parsed = ChatConversationReconnectRequest.safeParse(msg);
  if (!parsed.success) {
