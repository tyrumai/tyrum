...
export function toSubagent(raw: RawSubagentRow): SubagentDescriptor {
  return {
    ...
    parent_conversation_key: raw.parent_session_key ?? undefined,
    ...
    conversation_key: raw.session_key,
...
export function toWorkClarification(raw: RawWorkClarificationRow): WorkClarification {
  return {
    ...
    requested_for_conversation_key: raw.requested_for_session_key,
    ...
    answered_by_conversation_key: raw.answered_by_session_key ?? undefined,
    updated_at: normalizeTime(raw.updated_at),
  };
}
