-- Tyrum Gateway schema v2 (SQLite) — indexes.
...
CREATE INDEX IF NOT EXISTS secret_resolutions_secret_key_idx
...
ON vector_metadata (tenant_id, created_at DESC, vector_metadata_id DESC);
