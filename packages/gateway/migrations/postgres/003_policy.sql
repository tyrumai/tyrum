-- Policy snapshots + policy overrides (Postgres)
...
ALTER TABLE execution_jobs ADD COLUMN IF NOT EXISTS policy_snapshot_id TEXT;
CREATE INDEX IF NOT EXISTS execution_jobs_policy_snapshot_id_idx ON execution_jobs (policy_snapshot_id);

ALTER TABLE execution_runs ADD COLUMN IF NOT EXISTS policy_snapshot_id TEXT;
