...
CREATE TABLE IF NOT EXISTS policy_overrides (
  ...
  created_from_approval_id BIGINT,
...
ALTER TABLE approvals ADD COLUMN IF NOT EXISTS response_mode TEXT;
ALTER TABLE approvals ADD COLUMN IF NOT EXISTS policy_override_id TEXT;
ALTER TABLE approvals ADD COLUMN IF NOT EXISTS resolved_by_json TEXT;
